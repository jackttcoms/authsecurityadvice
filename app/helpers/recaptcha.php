...
<?php
    ...
    public function button($value = "Submit", $class = 'btn-primary active btn-sm') 
    {
        $html = '<button data-disable-with="Please wait..." class="btn '. $class .'" id="submit'. $this->form_id .'Form">'. $value .'</button>'."\n";
