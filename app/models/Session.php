...
class Session extends Model
{
    ...
    */
    ...
    {
        $sql = "INSERT INTO everything_sessions SET session_id = :session_id" . 
    ...
    */
    ...
    {
        $sql = "SELECT session_data FROM everything_sessions where session_id = :session_id";
    ...
    */
    ...
    {
        $sql = "DELETE FROM everything_sessions WHERE session_id = :session_id"; 
    ...
    */
    ...
    {
        $sql = "DELETE FROM everything_sessions WHERE session_lastaccesstime < DATE_SUB(NOW(), INTERVAL " . $lifetime . " SECOND)";
    ...
    */
    ...
    {
        $data = $this->db->select('everything_sessions');
